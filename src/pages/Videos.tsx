          ...
          <div className="bg-physics-dark rounded-lg p-6 w-full max-w-md">
            ...
            <div className="flex justify-between mb-4">
              <div className="flex gap-4">
                <button 
                  className={`px-4 py-2 rounded-lg ${!useYouTube ? 'bg-physics-gold text-physics-dark' : 'bg-physics-navy text-white'}`}
              ...
              <>
                {!showUploader ? (
                  <button
                    ...
                    className="w-full p-4 border-2 border-dashed border-physics-gold rounded-lg text-center hover:bg-physics-navy/30 transition"
                  >
                    <div className="flex flex-col items-center justify-center">
                      <FilePlus size={40} className="text-physics-gold mb-2" />
                      <p className="text-white font-medium">اضغط لاختيار فيديو</p>
                      <p className="text-gray-400 text-sm mt-1">
                        MP4, WebM, MOV (حجم الملف الأقصى: 10GB)
                      </p>
                    </div>
                  </button>
                ) : (
            ...
            <form onSubmit={handleEditVideo} className="space-y-4">
              ...
              <div>
                ...
                <input 
                  ...
                  required 
                  placeholder={editIsYouTube ? "https://www.youtube.com/watch?v=..." : "https://..."}
                />
